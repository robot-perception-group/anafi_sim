...
# axs[2].plot(time_blmpc_yaw_0, data_blmpc_yaw_0["z_anafi"]-9, color='darkorchid', label='$MPC-BL_0$')
# axs[2].plot(time_cempc_yaw_0, data_cempc_yaw_0["z_anafi"]-9, color='darkslategrey', label='$MPC-CE_0$')
#Response yaw = 180
axs[2].plot(time_pid_yaw_180, data_pid_yaw_180["z_anafi"], color='orange', label='$PID$')
axs[2].plot(time_blmpc_yaw_180, data_blmpc_yaw_180["z_anafi"]-9, color='blue', label='$MPC-BL$')
axs[2].plot(time_cempc_yaw_180, data_cempc_yaw_180["z_anafi"]-9, color='darkslategrey', label='$MPC-CE$')
...
# axs[3].plot(time_cempc_yaw_0,   np.rad2deg(data_cempc_yaw_0["yaw_anafi"]), color='darkslategrey', label='$MPC-CE_0$')
# Response yaw = 0
...
# Adjust layout
# plt.tight_layout()
plt.savefig("pics/static_yaw_180_real_world.pdf", format="pdf", bbox_inches="tight")
