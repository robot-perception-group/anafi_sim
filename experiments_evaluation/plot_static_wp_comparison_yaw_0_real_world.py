...
data_pid_yaw_0 =   pd.read_csv("real_world_data/static/static_0_pid.csv")
data_blmpc_yaw_0 =   pd.read_csv("real_world_data/static/static_0_blmpc.csv")
data_cempc_yaw_0 =   pd.read_csv("real_world_data/static/static_0_cempc.csv")

#Data handling of scenario with yaw=180
data_pid_yaw_180 = pd.read_csv("real_world_data/static/static_180_pid.csv")
data_blmpc_yaw_180 = pd.read_csv("real_world_data/static/static_180_blmpc.csv")
data_cempc_yaw_180 = pd.read_csv("real_world_data/static/static_180_cempc.csv")
...
#Response yaw = 0
axs[0].plot(time_pid_yaw_0, data_pid_yaw_0["x_anafi"], color='orange', label='$PID$')
axs[0].plot(time_blmpc_yaw_0, data_blmpc_yaw_0["x_anafi"], color='blue', label='$MPC-BL$')
axs[0].plot(time_cempc_yaw_0, data_cempc_yaw_0["x_anafi"], color='darkslategrey', label='$MPC-CE$')
#Response yaw = 180
# axs[0].plot(time_pid_yaw_180, data_pid_yaw_180["x_anafi"], color='orange', label='$PID_{180}$')
# axs[0].plot(time_blmpc_yaw_180, data_blmpc_yaw_180["x_anafi"], color='blue', label='$MPC-BL_{180}$')
# axs[0].plot(time_cempc_yaw_180, data_cempc_yaw_180["x_anafi"], color='darkslategrey', label='$MPC-CE_{180}$')
#Waypoint yaw = 0
...
#Response yaw = 0
axs[1].plot(time_pid_yaw_0, data_pid_yaw_0["y_anafi"], color='orange', label='$PID$')
...
# axs[1].plot(time_blmpc_yaw_180, data_blmpc_yaw_180["y_anafi"], color='blue', label='$MPC-BL{180}$')
# axs[1].plot(time_cempc_yaw_180, data_cempc_yaw_180["y_anafi"], color='darkslategrey', label='$MPC-CE{180}$')
...
#Waypoint yaw = 180
axs[2].plot(time_cempc_yaw_0, data_cempc_yaw_0["wp_z"]-9, color='c', linestyle='--', label='$WP$')
#Response yaw = 0
axs[2].plot(time_pid_yaw_0, data_pid_yaw_0["z_anafi"], color='orange', label='$PID$')
axs[2].plot(time_blmpc_yaw_0, data_blmpc_yaw_0["z_anafi"]-9, color='blue', label='$MPC-BL$')
axs[2].plot(time_cempc_yaw_0, data_cempc_yaw_0["z_anafi"]-9, color='darkslategrey', label='$MPC-CE$')
#Response yaw = 180
# axs[2].plot(time_pid_yaw_180, data_pid_yaw_180["z_anafi"], color='orange', label='$PID_{180}$')
# axs[2].plot(time_blmpc_yaw_180, data_blmpc_yaw_180["z_anafi"]-9, color='blue', label='$MPC-BL_{180}$')
# axs[2].plot(time_cempc_yaw_180, data_cempc_yaw_180["z_anafi"]-9, color='darkslategrey', label='$MPC-CE_{180}$')
...
axs[3].plot(time_pid_yaw_0,   np.rad2deg(data_pid_yaw_0["yaw_anafi"]), color='orange', label='$PID$')
axs[3].plot(time_blmpc_yaw_0,   np.rad2deg(data_blmpc_yaw_0["yaw_anafi"]), color='blue', label='$MPC-BL$')
axs[3].plot(time_cempc_yaw_0,   np.rad2deg(data_cempc_yaw_0["yaw_anafi"]), color='darkslategrey', label='$MPC-CE$')
# Response yaw = 0
# axs[3].plot(time_pid_yaw_180, np.rad2deg(data_pid_yaw_180["yaw_anafi"]), color='orange', label='$PID_{180}$')
# axs[3].plot(time_blmpc_yaw_180, np.rad2deg(data_blmpc_yaw_180["yaw_anafi"]), color='blue', label='$MPC-BL_{180}$')
# axs[3].plot(time_cempc_yaw_180, np.rad2deg(data_cempc_yaw_180["yaw_anafi"]), color='darkslategrey', label='$MPC-CE_{180}$')
# Response yaw = 180
axs[3].plot(time_blmpc_yaw_0,   data_blmpc_yaw_0["wp_yaw"], color='c', linestyle='--', label='$WP$')
# axs[3].plot(time_cempc_yaw_180, data_cempc_yaw_180["wp_yaw"], color='c', linestyle='--', label='$WP_{180}$')
...
# Adjust layout
# plt.tight_layout()
plt.savefig("pics/static_yaw_0_real_world.pdf", format="pdf", bbox_inches="tight")
