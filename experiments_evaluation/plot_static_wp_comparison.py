...
data_pid_yaw_0 =   pd.read_csv("sim_data/static_waypoint_yaw_0_pid.csv")
data_mpc_yaw_0 =   pd.read_csv("sim_data/static_waypoint_yaw_0_mpc.csv")
data_pid_yaw_180 = pd.read_csv("sim_data/static_waypoint_yaw_180_pid.csv")
data_mpc_yaw_180 = pd.read_csv("sim_data/static_waypoint_yaw_180_mpc.csv")
...
# Adjust layout
plt.tight_layout()
plt.savefig("pics/static_comparison.pdf", format="pdf", bbox_inches="tight")
