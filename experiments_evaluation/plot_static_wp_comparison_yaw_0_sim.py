...
#Response yaw = 0
axs[1].plot(time_pid_yaw_0, data_pid_yaw_0["y_anafi"], color='orange', label='$PID_0$')
...
axs[2].plot(time_blmpc_yaw_0, data_blmpc_yaw_0["z_anafi"], color='blue', label='$MPC-BL$')
axs[2].plot(time_cempc_yaw_0, data_cempc_yaw_0["z_anafi"], color='darkslategrey', label='$MPC-CE$')
...
axs[3].plot(time_cempc_yaw_0,   np.rad2deg(data_cempc_yaw_0["yaw_anafi"]), color='darkorchid', label='$MPC-CE$')
# Response yaw = 0
axs[3].plot(time_blmpc_yaw_0,   data_blmpc_yaw_0["wp_yaw"], color='c', linestyle='--', label='$WP_0$')
...
# Adjust layout
# plt.tight_layout()
plt.savefig("pics/static_yaw_0_sim.pdf", format="pdf", bbox_inches="tight")
